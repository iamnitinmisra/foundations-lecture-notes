...
// Point out the problem if there is a tie, our code would actually give the win to Jamie, which is no good. Demonstrate the use of else if to resolve this.
if (jonSnowAttack > jamieLannisterAttack) {
  console.log("Jon Snow has better attack than Jamie Lannister");
...
// Realizing his bag is overflowing, Jon decides to split up his content into two bags. Create a backpack2 variable that will hold some items. Use the slice method to move the flint, blanket, and knife from backpack to backpack2

var backpack2 = backpack.slice(2, 5);
